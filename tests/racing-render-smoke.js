...
assert(html.includes('css/dashboard.css?v=20260923-3'));
assert(html.includes('js/dashboard.js?v=20260923-3'));
...
assert(js.includes("requested !== 'running' && requested !== 'cycling' && requested !== 'swimming'"));
assert(js.includes("swimming ? 'Swimming Load' : cycling ? 'Cycling Load' : 'Running Load'"));
