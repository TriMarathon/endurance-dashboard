...
assert(html.includes('css/dashboard.css?v=20260923-4'));
assert(html.includes('js/dashboard.js?v=20260923-4'));
...
assert(js.includes("&& requested !== 'swimming' && requested !== 'strength'"));
assert(js.includes("strength ? 'Strength Load' : swimming ? 'Swimming Load'"));
